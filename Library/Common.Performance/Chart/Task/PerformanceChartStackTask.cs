...
{
    public class PerformanceChartStackTask : PerformanceChartTask
    {
        ...
        public PerformanceChartStackTask(PerformanceCounterObject pPerformanceCounterObject, int pCapacity)
        {
