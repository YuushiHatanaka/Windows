...
{
    public class LogicalDiskPerformanceChart : PerformanceChartList
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        ...
        public LogicalDiskPerformanceChart(String pCounterName, String pInstanceName, int pCapacity)
